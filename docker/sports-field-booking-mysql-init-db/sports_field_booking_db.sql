...
CREATE TABLE `notifications` (
  ...
  `type` enum('ORDER_STATUS_UPDATE','PROMOTION','YARD_STATUS_UPDATE','COMMENT_FEEDBACK') NOT NULL,
...
('3d723dc7-75dc-43d4-aebf-da449b56fd2a', '2024-11-07 11:18:06.275000', '126c7720-3664-45f4-8202-e00bf8b81de6', NULL, NULL, b'0', '2024-11-07 11:18:06.275000', NULL, 0, 'Magni consequatur vel praesentium aliquam et consequatur odio aperiam perferendis.', 'ORDER_STATUS_UPDATE', '6105d623-1ddf-4617-b285-2fadab6c464a', '126c7720-3664-45f4-8202-e00bf8b81de6',NULL),
('4ed5e09b-3324-416b-8c12-ed5d2610f435', '2024-11-07 11:18:06.249000', '4b39fcc6-1a05-41af-8504-fea9cba0248a', NULL, NULL, b'0', '2024-11-07 11:18:06.249000', NULL, 0, 'Vel nulla cupiditate quis optio vero aut illum perspiciatis sequi necessitatibus praesentium ipsa quia.', 'ORDER_STATUS_UPDATE', '6ad06a93-1ccb-4fc9-81b2-2c443b2faf3f', '4b39fcc6-1a05-41af-8504-fea9cba0248a',NULL),
...
('a8219d52-e4eb-4a80-8082-d30f11d8cb68', '2024-11-07 11:18:06.325000', 'dd3a7406-14b8-432a-9ac4-152fe76d2df0', NULL, NULL, b'0', '2024-11-07 11:18:06.325000', NULL, 0, 'Sed dignissimos amet nam nulla vero sapiente provident debitis libero dolorem voluptate corporis facere aperiam.', 'ORDER_STATUS_UPDATE', 'cfc08892-2416-47e6-8c85-e192d2d61c6f', 'dd3a7406-14b8-432a-9ac4-152fe76d2df0',NULL),
...
('eaf64502-3b14-45e5-9b5f-340660577a31', '2024-11-07 11:18:06.281000', '126c7720-3664-45f4-8202-e00bf8b81de6', NULL, NULL, b'0', '2024-11-07 11:18:06.281000', NULL, 0, 'Itaque perferendis dolorem ipsam eius et soluta recusandae sit molestiae reiciendis.', 'ORDER_STATUS_UPDATE', 'aca9e214-53a9-42ac-9a14-0f6b67c337b8', '126c7720-3664-45f4-8202-e00bf8b81de6',NULL);
...
CREATE TABLE `sports_fields` (
  ...
  `status` enum('CLOSED','INACTIVE','MAINTENANCE','OPEN','PENDING') NOT NULL,
...
ALTER TABLE `sports_fields`
  ...
  ADD KEY `fk_sports_fields_promotions` (`promotion_id`);
...
ALTER TABLE `sports_fields`
  ...
  ADD CONSTRAINT `fk_sports_fields_promotions` FOREIGN KEY (`promotion_id`) REFERENCES `promotions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
